...
argument-hint: <CHAVE-JIRA> | [plan-file] [execution-report-file]
---
...
- Suggest updates to AI-Layer assets (CLAUDE.md, `.claude/references/`, plan templates,
  `features/_template/`, skills, agents)
...
> **Entrada por chave:** se `$1` for uma chave do Jira (`PROJ-123`), os arquivos são
> `features/PROJ-123-*/plan.md`, `features/PROJ-123-*/execution-report.md`,
> `features/PROJ-123-*/feature.md` e `features/PROJ-123-*/checklist.md` (a tabela
> "Divergências do Plano" do checklist conta como relatório quando não houver
> `execution-report.md`).
