---
name: rca
description: Investiga um bug reportado (issue do Jira ou do GitHub), identifica a causa raiz e escreve um documento de RCA para a correção posterior. Use para diagnosticar antes de corrigir.
argument-hint: <CHAVE-JIRA | github-issue-id>
---
...
**Prerequisites:**
- Chave do Jira válida com o MCP do Atlassian conectado — **ou** issue do GitHub com o
...
**Se `$ARGUMENTS` for uma chave do Jira** (`PROJ-123`):
...
Extraia: passos de reprodução, comportamento esperado x observado, ambiente, anexos e logs.
Se for um bug de API, o **status HTTP retornado x esperado** é a pista mais valiosa — o contrato
de erro deste projeto deriva o status do sufixo da mensagem da exceção
(`.claude/references/clean-architecture-dotnet.md` §10), e um 500 inesperado quase sempre
significa sufixo ausente.

**Se for um número de issue do GitHub, use o CLI:**
